...
public class Day13_NoSuchElementException {
    ...
    public void noSuchElementExceptionTest(){
        ...
        driver.findElement(By.linkText("navLogon")).click();//Wrong locator.linkText should be id.
    ...
    public void noSuchElementExceptionTest2(){
        ...
        String helloWorld = driver.findElement(By.xpath("//div[@id='finish']//h4"))
                .getText();
        Assert.assertEquals("Hello World!",helloWorld);//ComparisonFailure. This is not
        // same as no such element exception
    }
    @Test
